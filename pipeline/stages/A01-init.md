...
- [URL 1] — [Ce qu'on retient]
- [URL 2] — [Ce qu'on retient]

> Minimum 2 références. Si pas encore fournies par le client : noter "En attente client".
...
- [ ] Au moins 2 références visuelles (ou "En attente client")
